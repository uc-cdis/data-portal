...
class Covid19Dashboard extends React.Component {
  ...
  render() {
    ...
    const seirChart = displaySeirPlot ? <PlotChart
      ...
      description = 'The simulated cases(red curve) generated by SEIR model is in consistant with the observed cases (blue curve). The red curve also shows the forcasted cases in 14 days.'
      plots={[
        {
