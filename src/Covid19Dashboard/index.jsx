...
class Covid19Dashboard extends React.Component {
  ...
  render() {
    ...
    const seirChart = displaySeirPlot ? (<PlotChart
      title='Forecasting covid-19 cases with SEIR model'
      xTitle='Date'
      yTitle='Population'
      description='The simulated cases(blue curve) generated by SEIR model is in consistant with the observed cases (dark red curve). The red curve also shows the forcasted cases in 14 days.'
      plots={seirPlotChart}
    />) : null;
