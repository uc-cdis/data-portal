...
const deleteNode = ({ id, project }) => (dispatch) => fetchWithCreds({
...
const fetchQueryNode = ({ id, project }) => (dispatch) => fetchWithCreds({
...
const mapDispatchToProps = (dispatch) => ({
  ...
  onStoreNodeInfo: ({ id, project }) => dispatch(fetchQueryNode({ id, project }))
