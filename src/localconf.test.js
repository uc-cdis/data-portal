...
describe( "The localconf", function() {
  const expectedKeys = [
      "dev",
      "mockStore",
      "app",
  ...
  it( "Defines a bunch of configuration variables", function() {
  ...
  it( "Defines an 'app' variable", function() {
    expect( !! conf.app ).toBe( true );
  });

  it( "supports buildConfig(app)", function() {
