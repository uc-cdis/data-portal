...
function buildConfig(opts) {
  ...
  const workspaceUrl = ensureTailingSlash(process.env.WORKSPACE_URL) || '/lw-workspace/';
  ...
  const manifestServiceApiPath = ensureTailingSlash(process.env.MANIFEST_SERVICE_URL) || `${hostname}manifests/`;
