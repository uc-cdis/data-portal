...
class GraphDrawer extends React.Component {
  ...
  componentDidUpdate() {
    ...
    if (
      ...
      const graphNodesSVGElements = this.props.nodes
        .map((node) => ({
          nodeID: node.id,
      ...
      >
        {this.props.edges.map((edge, i) => {
          ...
          if (this.props.isSearchMode) {
            ...
            if (this.props.secondHighlightingNodeID) {
              const isEdgeAlongPathRelatedToSecondHighlightNode = !!this.props.pathRelatedToSecondHighlightingNode.find(
                (e) => e.source === edge.source && e.target === edge.target
              );
              isEdgeHalfFaded =
                isEdgeRelatedToHighlightedNode &&
        ...
        {this.props.nodes.map((node) => {
          ...
          if (this.props.isSearchMode) {
            ...
            isNodeDashed =
              this.props.matchedNodeIDsInNameAndDescription.length > 0 &&
              !isNodeFaded &&
              !this.props.matchedNodeIDsInNameAndDescription.includes(node.id);
            ...
            isNodeClickable =
              ...
              (this.props.secondHighlightingNodeCandidateIDs.length > 1 &&
                this.props.secondHighlightingNodeCandidateIDs.includes(
                  node.id
                ));
            ...
            if (this.props.secondHighlightingNodeID) {
              isNodeHalfFaded =
                !isNodeFaded &&
                !this.props.pathRelatedToSecondHighlightingNode.find(
