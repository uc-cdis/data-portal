...
class ExplorerFilter extends React.Component {
  ...
  render() {
    const filterProps = {
      ...
      disabledTooltipMessage: this.props.tierAccessLevel === 'regular' ? `This resource is currently disabled because you are exploring restricted data. When exploring restricted data you are limited to exploring cohorts of at least ${this.props.tierAccessLimit} ${this.props.guppyConfig.nodeCountTitle.toLowerCase() || this.props.guppyConfig.dataType}` : '',
    };
    let filterFragment;
    switch (this.state.selectedAccessFilter) {
    case 'all-data':
