  ...
  render() {
    return (
      <div className='tier-access-selector'>
        <h4 className='tier-access-selector__dropdown'>
          <span className='tier-access-selector__title'>Data Access</span>
          <i className='tier-access-selector__dropdown-icon g3-icon g3-icon__chevron-up' />
        </h4>
        <form>
          <div className='tier-access-selector__items'>
            <div className='tier-access-selector__item'>
              <input onChange={this.handleSelectorChange} name='access-level' id='with-access' value='with-access' className='tier-access-selector__radio-input' type='radio' />
            ...
            <div className='tier-access-selector__item'>
              <input onChange={this.handleSelectorChange} name='access-level' id='without-access' value='without-access' className='tier-access-selector__radio-input' type='radio' />
              <i className='tier-access-selector__customized-radio-input' />
              <label htmlFor='without-access' className='tier-access-selector__label'>Data without Access</label>
            </div>
            <div className='tier-access-selector__item'>
              <input onChange={this.handleSelectorChange} name='access-level' id='all-data' value='all-data' className='tier-access-selector__radio-input' type='radio' />
              <i className='tier-access-selector__customized-radio-input' />
