...
export const isProgramUrl = (urlFragment) =>
...
export const listifyMethodsFromMapping = (actions) => {
  ...
  const reducer = (accumulator, currval) =>
    accumulator.concat([currval.method]);
