...
const helperSingleton = {
  ...
  explorerPageFragment: graphql.experimental`fragment gqlHelperExplorerFragment on viewer
  @argumentDefinitions(
  ...
  explorerRefreshQuery: graphql.experimental`query gqlHelperExplorerRefreshQuery (
