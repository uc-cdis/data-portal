...
const mapDispatchToProps = (dispatch) => ({
  ...
  onChatbotSearchChange: (chatbotSearchTerm) => dispatch({ type: 'CHATBOT_SEARCH_TERM_SET', chatbotSearchTerm }),
