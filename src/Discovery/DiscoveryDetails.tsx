...
const labeledMultipleLinkField = (labelText: string, linksText: string[]) => (linksText.length ? (
  <div>
    {[
      // labeled first field
      <div {...fieldCls}>
  ...
  if (resource[accessibleFieldName] === AccessLevel.UNACCESSIBLE) {
    return (
      <Alert
        ...
        type='warning'
        message={
          <React.Fragment>You do not have access to this study.</React.Fragment>
        }
      />
    );
  }
                    ...
                    >
                      ...
                      {fieldGroup.fields.map((field) => {
                        ...
                        const multiline = props.modalData[field.field]
                          && props.modalData[field.field].length
                            > MULTILINE_FIELD_CHARLIMIT;
                        ...
                        if (props.modalData[linkingField] !== undefined) {
                          return (
                            <a href={props.modalData[linkingField]}>
