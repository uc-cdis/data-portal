...
const WorkflowParameters = ({ selectedHare, handleHareSelect, caseCohortDefinitionId, controlCohortDefinitionId, selectedCovariates, selectedDichotomousCovariates, sourceId, workflowType }) => {
