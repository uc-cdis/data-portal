    ...
    return (data?.cohort_overlap.case_control_overlap_after_filter === 0) ?
        (
            <div className="GWASUI-flexCol">
                ...
                {500} subjects were found in {selectedCaseCohort.cohort_name} cohort and <br/>
                {600} subjects were found in {selectedControlCohort.cohort_name} cohort.<br/>
        ...
        (
            <div className="GWASUI-flexCol">
                Based on the selected covariates their respective data within the study population,<br/>
                {90} subjects were found in <b>{selectedCaseCohort.cohort_name}</b> cohort and <br/>
                {5} subjects were found in <b>{selectedControlCohort.cohort_name}</b> cohort.<br/>
