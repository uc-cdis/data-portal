...
const Completed = () =>
    <span className='job-status-icon'>
        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48">
            <g id="Completed" transform="translate(-860 -428)">
                <circle id="Ellipse" cx="24" cy="24" r="24" transform="translate(860 428)" fill="#5ac561"/>
                <path id="check"
                    ...
                    transform="translate(865.053 433.63)" fill="#fff"/>
            </g>
        </svg>
    </span>
