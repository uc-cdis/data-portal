  ...
  const applyAutoGenFilters = () => {
    if (tableType === 'Case Cohort') {
      return {
        ...
        provided_name:
          'Autogenerated Covariate for Filtering Control Population ',
      };
    } else if (tableType === 'Control Cohort') {
      return {
        variable_type: 'custom_dichotomous',
        cohort_ids: [
          selectedCohort.cohort_definition_id,
        ...
        provided_name: 'Autogenerated Covariate for Filtering Case Population ',
      };
    } else return {};
  };
