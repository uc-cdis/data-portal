        ...
        <div style={flexCol}>
                ...
                <>
                    <label className='GWASUI-label' htmlFor='input-maf'>
                        ...
                        <InputNumber
                            id='input-maf'
                            value={mafThreshold}
                            onChange={(e) => setWorkflow({ type: "mafTheshold", update: Number(e) })}
                            stringMode
                            step='0.01'
                            min={'0'}
                            max={'0.5'}
            ...
            <div style={flexRow}>
                <>
                    ...
                    {/* setWorkflow({ type: "selectedHare", update: selectedHare }) */}
                </>
                <>
                    <label className='GWASUI-label' htmlFor='input-imputation'>
                        ...
                        <InputNumber
                            ...
                            onChange={(e) => setWorkflow({ type: "imputationScore", update: Number(e) })}
                            stringMode
                            step='0.1'
                            min={'0'}
                            max={'1'}
