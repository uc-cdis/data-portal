...
const CohortsOverlapDiagram = ({
  ...
  const {
    ...
    dataStudyPopulationAndCaseMinusStudyPopulationAndCaseAndControl: results[3].data,
  };

  useEffect(() => {
    // Validate and give error message if there is no overlap:
    if (dataStudyPopulationAndCase?.cohort_overlap
        && dataStudyPopulationAndControl?.cohort_overlap) {
      if (dataStudyPopulationAndCase.cohort_overlap.case_control_overlap === 0
  ...
  const eulerArgs = {
    ...
    set13Size: dataStudyPopulationAndControl.cohort_overlap.case_control_overlap,
    ...
    set123Size:
      ...
      - dataStudyPopulationAndCaseMinusStudyPopulationAndCaseAndControl.cohort_overlap.case_control_overlap,
