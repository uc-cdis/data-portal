...
storiesOf('Dropdown', module)
  ...
  .add('Single Dropdown', () => (
    <Dropdown buttonType='secondary' className='my-dropdown'>
      ...
      <Dropdown.Menu>
        <Dropdown.Item
          onClick={action('exportToWorkspace clicked')}
          leftIcon='datafile'
        >
          Export to Workspace
        </Dropdown.Item>
        <Dropdown.Item
          onClick={action('exportToAnalyzerApp clicked')}
          leftIcon='upload'
        >
          Export to Analyzer App
        </Dropdown.Item>
        <Dropdown.Item
          onClick={action('exportToTSV clicked')}
          leftIcon='clinical'
          disabled
        >
        ...
        <Dropdown.Item
          onClick={action('exportPFBToWorkspace clicked')}
          leftIcon='workspace'
        >
