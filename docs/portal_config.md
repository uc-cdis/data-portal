...
```
{
  ...
  "studyRegistrationConfig": { // optional, config for Study Registration and Study Registration Request Access page.
    ...
    "studyRegistrationFormDisclaimerField": "This is a diclaimer", //optional, the diclaimer text that appears under the submit button on the study registration form. Defaults to undefined
  },
