module.exports = {
  ...
  overrides: [{
    files: ['src/Submission/SubmitTSV.test.jsx', 'src/GraphUtils/utils.js', 'src/GraphUtils/utils.test.js', 'src/actions.js', 'data/getSchema.js', 'data/getTexts.js', 'data/gqlSetup.js', 'src/SessionMonitor/index.js', 'src/Index/utils.js', 'src/Workspace/index.jsx'],
    rules: {
      'no-console': 'off' // for logging errors

    }
  }, {
    files: ['src/Submission/SubmitTSV.jsx', 'src/Submission/SubmissionResult.jsx', 'src/CoreMetadata/reduxer.js' // for reducer
    ],
    rules: {
    ...
    files: ['src/DataDictionary/GraphCreator.js', 'src/GraphUtils/testData.js', 'src/GraphUtils/utils.js', 'src/Submission/ReduxMapFiles.js', 'src/Submission/ReduxSubmissionHeader.js'],
    rules: {
