...
storiesOf('General/Typography', module)
  .add('Typography normal', () => (
    <div>
      ...
      <div className='typo-demo-block'>
        <h2>H2 - This is a main title</h2>
      </div>
      <div className='typo-demo-block'>
        <h3>H3 - This is a main title</h3>
      </div>
      <div className='typo-demo-block'>
        <h4>H4 - This is a main title</h4>
      </div>
      <div className='typo-demo-block'>
        <div className='introduction'>
          This is some introduction: Lorem ipsum dolor sit amet, consectetur
          adipiscing elit. Cras dapibus vulputate diam eu pretium. Mauris elit
          orci, ultricies id fermentum vel, porta et eros. Vestibulum
          condimentum lectus
        </div>
      </div>
      <div className='typo-demo-block'>
        <div className='body'>
          This is body: Lorem ipsum dolor sit amet, consectetur adipiscing elit.
          Cras dapibus vulputate diam eu pretium. Mauris elit orci, ultricies id
          ...
          dui feugiat scelerisque eu quis diam. Mauris placerat congue dui
        </div>
      </div>
      <div className='typo-demo-block'>
